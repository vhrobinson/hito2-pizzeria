    ...
    return (
        ...
        <form  className="max-w-sm mx-auto">
          <h1 className="text-3xl">Register </h1>
            <div className="mb-5">
                <label for="email" className="block mb-2 text-sm font-medium text-gray-600 text-white">Email</label>
            ...
            <div className="mb-5">
                <label for="password" className="block mb-2 text-sm font-medium text-gray-600 :text-white
          ...
          <input type="password" id="password" value={password}
            ...
            <div className="mb-5">
                <label for="rpassword" className="block mb-2 text-sm font-medium text-white-600 :text-white
